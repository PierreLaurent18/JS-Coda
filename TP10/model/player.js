...
export default class Player {
    constructor(id, name, skinPath, position) {
        ...
        this.attackSpriteDuration = 8;

        this.deathSpriteIndex = 0;
        this.deathSpritesNumber = 5;
    ...
    update(updateData) {
        ...
        this.last_x = this.new_x;
        this.last_y = this.new_y;
        [this.new_x, this.new_y] = updateData.position;
    ...
    interpolate(alpha) {
        this.renderX =  this.last_x + (this.new_x-this.last_x)*alpha;
        this.renderY = this.last_y + (this.new_y-this.last_y)*alpha
    }
}
